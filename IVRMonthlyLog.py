...
previous_month_days = calendar.monthrange(2023,10)[1]
current_month_days = calendar.monthrange(2023,11)[1]

# get the numver of weeks in given month
previous_month_weeks = len(calendar.monthcalendar(2023,10))
current_month_weeks = len(calendar.monthcalendar(2023,11))

# set the month
previous_month = '2023/11/01'
current_month = '2023/12/01'
year_month = '2023年11月'

# set the output file name
output_filename = '202311_IVRCustomer.xlsx'
...
result_df.to_excel(f'{output_filename}')
