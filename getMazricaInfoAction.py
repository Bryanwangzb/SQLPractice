...
async def main():
    ...
    df_ivr_customer_info = pd.read_csv("deals_data.csv",usecols=["ID","Customer Id","Customer","ivr_company_name","ivr_company_id"])
    ...
    # CSVファイルに出力
    df.to_csv("actions_data.csv", index=False, encoding='utf-8-sig')
