...
def main():
    ...
    csv_filename = powerBI_csv_analysis + '\\deals_data_tmp.csv'
    write_to_csv(deals, csv_filename)

    df_deal_data = pd.read_csv(powerBI_csv_analysis + '\\deals_data_tmp.csv')
    ...
    df_merged.to_csv(powerBI_csv_analysis + "\\deals_data.csv",index=False)
